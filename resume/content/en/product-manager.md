---
title: "Jiazhao Xu – Product Manager"
...
**Product Manager** <span class="resume-contact">E-mail: <a href="mailto:hello@xujiazhao.com">hello@xujiazhao.com</a> · Phone: 189-1016-3319 · WeChat: xux-ai · Portfolio: <a href="https://www.xux.ai">www.xux.ai</a></span>
...
- Engaged directly with end users and strategic partners through partner summits and workshops (e.g., CNN, Eastmoney for MSN Partner Hub) to gather feedback, understand evolving needs, and drive ongoing product improvements.
- Followed up on post-launch user feedback and analytics, driving continuous improvements and ensuring features evolved to meet changing needs.
...
- Serving as Class President and cohort liaison, actively promoting industry-academia collaboration and resource integration; organized company visits, alumni roundtables, and closed-door corporate sharing sessions to expand the Tsinghua SEM network.
- Vice President of the MBA Embodied Intelligence Club, liaising with companies in embodied intelligence, robotics, and AI startups, and leading site visits, roundtable discussions, and contributions to the industry white paper.
...
- Graduated with honors; exchange program at INSEAD (Europe campus). interned at Xiaomi, Kohler, and Ant Group.

---

## Skills, Languages & Interests

- **Skills:** Roadmap Planning, Feature Prioritization, Sprint Management, PRD Writing, A/B Testing, Data Analysis, Figma, Design Systems, Prototyping, User Research, Usability Testing, Lean Interaction Design, HTML/CSS, React, Vibecoding, Prompt Engineering, AI Product Design, Stakeholder Management, Go-to-Market Strategy, Growth Metrics, Workshop Facilitation, Adobe Creative Suite

- **Languages:** Chinese (Native), English (Business Fluent)
